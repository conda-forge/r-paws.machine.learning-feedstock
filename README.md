...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-paws.machine.learning-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14242&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-paws.machine.learning-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-paws.machine.learning` can be installed with:

```
conda install r-paws.machine.learning
```

It is possible to list all of the versions of `r-paws.machine.learning` available on your platform with:
